...
<body>
    ...
    <p style="color: red;">${error}</p>
		...
		<form:form action="/com.stu/UserUpdate"   method="post" modelAttribute="user" >
		
        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Update</h2>
        <c:forEach var="us" items="${us}">
        <div class="row mb-4">
        
            <div class="col-md-2"></div>
            <label for="email" class="col-md-2 col-form-label">Name</label>
            <div class="col-md-4">
            <form:hidden path="id" value ="${us.id}"/>
          

              <form:input path="name" type="text" class="form-control" id=""  value="${us.name}"  required = "true"/>  
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                ...
                <form:input path="email"  type="email" class="form-control" id="email" value="${us.email }"  required="true"/>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col-md-2"></div>
            ...
            <div class="col-md-4">
            <form:input path="password" type="password" class="form-control" id="name" required="true"/>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
            <form:input path="confirm" type="password" class="form-control" id="confirmPassword"  required="true"/>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
            <form:select path="role" class="form-select" aria-label="Education" id="userRole" value = "${us.role } " required="true">
