...
<body>
    ...
    <div>
    	...
    	<form:form action="/com.stu/UserReigster" method="post" modelAttribute="user"            >
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input type="password" class="form-control" id="name" path="password" required="true"/>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input type="password" class="form-control" id="confirmPassword" path="confirm" required="true"/>
            ...
            <div class="row mb-4">
                ...
                <form:select class="form-select" aria-label="Education" name="role" path="role">
