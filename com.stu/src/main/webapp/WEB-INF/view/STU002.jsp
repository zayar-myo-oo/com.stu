...
<body>
    ...
    <form:form modelAttribute="stud" action="/com.stu/StudentUpdate"  method="post">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input path="id" type="text" class="form-control" value="${stu.id }"  id="studentID" readonly="true"/>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input path="name"  type="text" class="form-control" id="name"  value="${stu.name }" required="true"/>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input path="dob" type="date" class="form-control" value="${stu.dob }" id="dob" required="true"/>
            ...
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <form:radiobutton path="gender" class="form-check-input"  name="gender" id="gridRadios1" value="male"
                    ...
                    <div class="form-check-inline">
                        <form:radiobutton path="gender" class="form-check-input"  name="gender" id="gridRadios1" value="female"
                           required="true" />
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                <form:input path="phone" type="text" class="form-control" id="phone"  value="${stu.phone }" required="true"/>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <a href="/com.stu/StudentDelete/${stu.id }">
